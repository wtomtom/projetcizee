...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* vizee features */
        {"vizee", "masternode", &masternode, true, true, false},
        {"vizee", "masternodelist", &masternodelist, true, true, false},
        {"vizee", "mnbudget", &mnbudget, true, true, false},
        {"vizee", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"vizee", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vizee", "mnsync", &mnsync, true, true, false},
        {"vizee", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"vizee", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> vizee-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:75015/\n";
}
