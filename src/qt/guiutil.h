...
/** Utility functions used by the vizee Qt UI.
 */
namespace GUIUtil
{
...
// Render vizee addresses in monospace font
...
// Parse "vizee:" URI into recipient object, return true on successful parsing
