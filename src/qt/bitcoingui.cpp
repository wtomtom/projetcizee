                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("vizee Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a vizee address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vizee: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About vizee Core"), this);
    aboutAction->setStatusTip(tr("Show information about vizee Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for vizee"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your vizee addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified vizee addresses"));
    ...
    openAction->setStatusTip(tr("Open a vizee: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the vizee Core help message to get a list with possible vizee command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("vizee Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to vizee network", "", count));
}
...
{
    QString strTitle = tr("vizee Core"); // default title
