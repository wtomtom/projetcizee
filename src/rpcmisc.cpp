...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total vizee balance of the wallet\n"
            "  \"obfuscation_balance\": xxxxxx, (numeric) the anonymized vizee balance of the wallet\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in vizee/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in vizee/kb\n"
...
#ifdef ENABLE_WALLET
        // Case 1: vizee address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are vizee addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) vizee address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
