...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("vizee Core vizee-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vizee-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vizee transaction") + "\n" +
                               "  vizee-tx [options] -create [commands]   " + _("Create hex-encoded vizee transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vizee transaction
