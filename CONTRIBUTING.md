Contributing to vizee Core
============================

The vizee Core project operates an open contributor model where anyone is
...
The following applies to code changes to the vizee Core project, and is not to be
confused with overall vizee Network Protocol consensus changes.

Whether a pull request is merged into vizee Core rests with the project merge
...
Patches that change vizee consensus rules are considerably more involved than
...
Where a patch set proposes to change the vizee consensus, it must have been
...
The project leader is the release manager for each vizee Core release.
