...
This mechanism has been integrated into Bitcore-Node-VZE which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/VZE-Project/insight-api-vizee#web-socket-api](https://github.com/VZE-Project/insight-api-vizee#web-socket-api) 
* API: [https://github.com/VZE-Project/insight-api-vizee#swifttx-transactions](https://github.com/VZE-Project/insight-api-vizee#swifttx-transactions) 
...
By default, the VZE Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the VZE Core daemon:
