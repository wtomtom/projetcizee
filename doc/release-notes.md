...
vizee Core is extensively tested on multiple operating systems using
...
vizee Core should also work on most other Unix-like systems but is not
...
of Bitcoin that vizee was forked from.
