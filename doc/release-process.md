...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/vizee-Project/vizee/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign vizee Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit vizee=v${VERSION} ../vizee/contrib/gitian-descriptors/gitian-osx.yml
...
Codesigner only: Sign the osx binary:
    ...
    transfer vizee-osx-unsigned.tar.gz to osx for signing
...
- Detached signatures will then be committed to the [vizee-detached-sigs](https://github.com/vizee-Project/vizee-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/vizee-Project/vizee/releases/new) with a link to the archived release notes.
