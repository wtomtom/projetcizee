...
In order to support loading of multiple wallets in vizee-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vizee.cpp.
...
Changes to vizee.cpp
----------------------
vizee.cpp is the entry point into vizee-qt, and as such, will require some minor modifications to provide hooks for
